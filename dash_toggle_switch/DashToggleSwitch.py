...
class DashToggleSwitch(Component):
    """A DashToggleSwitch component.
...
- value (string; optional): The value displayed in the input"""
    ...
    def __init__(self, id=Component.UNDEFINED, label=Component.REQUIRED, value=Component.UNDEFINED, **kwargs):
        ...
        self._type = 'DashToggleSwitch'
        self._namespace = 'dash_toggle_switch'
        ...
        super(DashToggleSwitch, self).__init__(**args)
